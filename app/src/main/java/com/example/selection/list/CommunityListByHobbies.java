...
public class CommunityListByHobbies extends RecyclerView.Adapter<CommunityListByHobbies.ListViewHolder> {
    private Context context;
    private List<KomunitasHobby> komunitasList;
    private ImageView foto;
    private ItemClickListener itemClickListener;
    private TextView nama, alamat, id;
    private RatingBar rating;

    public CommunityListByHobbies(Context context, List<KomunitasHobby> komunitasList, ItemClickListener itemClickListener) {
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CommunityListByHobbies.ListViewHolder(view, itemClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        KomunitasHobby komunitas = komunitasList.get(position);
    ...
    class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            itemClickListener.onItemClickView(getAdapterPosition());
        }
    }
